    ...
    <div style={{minHeight:'100vh',background:'#f8fafc',fontFamily:'Inter,sans-serif'}}>
      <nav style={{background:'#fff',borderBottom:'1px solid #e2e8f0',height:56,display:'flex',alignItems:'center',padding:'0 24px',gap:16}}>
        <Link href="/dashboard" style={{display:'flex',alignItems:'center',gap:8,textDecoration:'none'}}>
          <div style={{width:26,height:26,borderRadius:6,background:'#d97706',display:'flex',alignItems:'center',justifyContent:'center',fontSize:12,fontWeight:800,color:'#fff'}}>V</div>
      ...
      <div style={{maxWidth:640,margin:'0 auto',padding:'40px 24px'}}>
        ...
        <p style={{fontSize:14,color:'#64748b',marginBottom:28}}>Paste raw client feedback and get a polished testimonial.</p>
        ...
        {error === 'limit_reached' && (
          <div style={{background:'#fafafa',border:'2px solid #d97706',borderRadius:14,padding:24,marginBottom:20,textAlign:'center'}}>
            ...
            <div style={{background:'#f1f5f9',borderRadius:8,padding:'10px 16px',marginBottom:16,textAlign:'left'}}>
              ...
              <div style={{background:'#e2e8f0',borderRadius:4,height:6}}>
                <div style={{background:'#d97706',borderRadius:4,height:6,width:'100%'}}/>
              </div>
            </div>
            <div style={{display:'flex',gap:10,justifyContent:'center'}}>
              ...
              <a href="/billing"
                style={{padding:'10px 20px',borderRadius:8,border:'none',background:'#d97706',color:'#fff',fontSize:14,fontWeight:700,textDecoration:'none',display:'inline-flex',alignItems:'center'}}>
                Upgrade now →
              </a>
            </div>
        ...
        {result ? (
          ...
          <div style={{background:'#fff',border:'1px solid #e2e8f0',borderRadius:12,padding:28}}>
            ...
            <button onClick={handleSubmit} disabled={loading}
              style={{width:'100%',background:loading?'#94a3b8':'#d97706',color:'#fff',padding:'13px',borderRadius:10,border:'none',fontSize:15,fontWeight:700,cursor:loading?'not-allowed':'pointer',fontFamily:'Inter,sans-serif'}}>
