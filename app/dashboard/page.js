...
const COLOR = '#d97706'
const PRODUCT_NAME = 'Vochly'
const PRODUCT_INITIAL = 'V'
const COOKIE = 'voc'
...
const Logo = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="vo1" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#fbbf24"/>
        <stop offset="100%" stopColor="#b45309"/>
      </linearGradient>
    </defs>
    <path d="M15 20 Q15 12 23 12 L77 12 Q85 12 85 20 L85 58 Q85 66 77 66 L40 66 L25 80 L28 66 L23 66 Q15 66 15 58 Z" fill="url(#vo1)"/>
    <circle cx="36" cy="39" r="7" fill="white" opacity="0.9"/>
    <circle cx="50" cy="39" r="7" fill="white" opacity="0.9"/>
    <circle cx="64" cy="39" r="7" fill="white" opacity="0.9"/>
  </svg>
)
  ...
  const Sidebar = () => (
    <div style={{width:220,background:'linear-gradient(180deg,#0a0f2e 0%,#0f172a 100%)',display:'flex',flexDirection:'column',padding:'20px 12px',height:'100vh',position:'sticky',top:0,flexShrink:0,overflowX:'hidden'}}>
      ...
      <div style={{marginTop:'auto',borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:14}}>
        ...
        <button onClick={() => { document.cookie='voc_token=;max-age=0'; document.cookie='voc_user=;max-age=0'; router.push('/login') }}
